...
namespace NandiAPI.Migrations
{
    ...
    [Migration("20250117155943_InitialDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NandiAPI.Entities.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NandiAPI.Entities.BookCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NandiAPI.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NandiAPI.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NandiAPI.Entities.Book", b =>
                {
                    b.HasOne("NandiAPI.Entities.BookCategory", "BookCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("NandiAPI.Entities.Order", b =>
                {
                    b.HasOne("NandiAPI.Entities.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NandiAPI.Entities.User", "User")
                        .WithMany()
